...
# run this: C:\ArcGIS\Pro\bin\Python\scripts\propy.bat C:\Users\b35143921880\Documents\odcm_main_4AM_traffic_analysis.py
...
# --- destinations ---
    ...
    # --- network analysis ---
        ...
        #time_of_day = datetime.datetime.strptime("01/03/1900" + " " + horarios[j], '%m/%d/%Y %I:%M:%S %p') # change start datetime for your analysis
        time_of_day = datetime.datetime.strptime("12/31/1899" + " " + horarios[j], '%m/%d/%Y %I:%M:%S %p') # change start datetime for your analysis
